...
Prefer checked-in presets for repeatable local and CI workflows:
...
Use the bundled scripts in this skill to keep the build loop consistent:

```bash
python skills/cpp-pro/scripts/audit_cpp_project.py --repo-root .
python skills/cpp-pro/scripts/run_cpp_quality_gates.py --repo-root . --preset dev --with-clang-format
python skills/cpp-pro/scripts/run_cpp_quality_gates.py --repo-root . --preset asan --skip-format --skip-clang-tidy
```
